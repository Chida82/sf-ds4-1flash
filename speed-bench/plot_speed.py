#!/usr/bin/env python3
"""Generate an SVG throughput graph from a sf-ds4-1flash-bench CSV file.
...
def main():
    parser = argparse.ArgumentParser(description="Plot sf-ds4-1flash-bench throughput CSV data as SVG.")
    parser.add_argument("csv", type=Path, help="input CSV produced by sf-ds4-1flash-bench")
