...
`sf-ds4-1flash-eval` contains small, curated subsets of external benchmarks. They are
...
benchmark-specific output wrapper was removed because `sf-ds4-1flash-eval` supplies one
